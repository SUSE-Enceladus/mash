...
BuildRequires:  python3-cryptography >= 3.1.0
BuildRequires:  python3-jsonschema
BuildRequires:  python3-PyYAML
BuildRequires:  python3-PyJWT
BuildRequires:  python3-amqpstorm >= 3.1.0
BuildRequires:  python3-APScheduler >= 3.3.1
BuildRequires:  python3-python-dateutil >= 2.6.0
BuildRequires:  python3-python-dateutil < 3.1.0
...
Requires:       python3-cryptography >= 3.1.0
Requires:       python3-jsonschema
Requires:       python3-PyYAML
Requires:       python3-PyJWT
Requires:       python3-amqpstorm >= 3.1.0
Requires:       python3-APScheduler >= 3.3.1
Requires:       python3-python-dateutil >= 2.6.0
Requires:       python3-python-dateutil < 3.1.0
