...
from mash.services.test_cleanup_service import main


class TestImgProofTestCleanupServiceMain(object):
    @patch('mash.services.test_cleanup_service.BaseJobFactory')
    @patch('mash.services.test_cleanup_service.TestCleanupConfig')
    @patch('mash.services.test_cleanup_service.ListenerService')
