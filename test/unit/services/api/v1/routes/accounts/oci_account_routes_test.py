...
@patch('mash.services.api.v1.utils.accounts.oci.handle_request')
@patch('mash.services.api.v1.routes.accounts.oci.get_jwt_identity')
...
def test_api_delete_account_oci(
    ...
    result = test_client.delete('/v1/accounts/oci/test')
...
def test_api_get_account_oci(
    ...
    result = test_client.get('/v1/accounts/oci/test')
    ...
    response = test_client.get('/v1/accounts/oci/test')
...
def test_api_get_account_list_oci(
    ...
    result = test_client.get('/v1/accounts/oci/')
