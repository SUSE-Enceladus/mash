...
@patch('mash.services.api.v1.utils.accounts.ec2.handle_request')
@patch('mash.services.api.v1.routes.accounts.ec2.get_jwt_identity')
...
def test_api_delete_account_ec2(
    ...
    result = test_client.delete('/v1/accounts/ec2/test')
...
def test_api_get_account_ec2(
    ...
    result = test_client.get('/v1/accounts/ec2/test')
...
def test_api_get_account_list_ec2(
    ...
    result = test_client.get('/v1/accounts/ec2/')
