...
@patch('mash.services.api.v1.utils.accounts.azure.handle_request')
@patch('mash.services.api.v1.routes.accounts.azure.get_jwt_identity')
...
def test_api_delete_account_azure(
    ...
    result = test_client.delete('/v1/accounts/azure/test')
...
def test_api_get_account_azure(
    ...
    result = test_client.get('/v1/accounts/azure/test')
...
def test_api_get_account_list_azure(
    ...
    result = test_client.get('/v1/accounts/azure/')
