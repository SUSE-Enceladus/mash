...
@patch('mash.services.api.v1.utils.accounts.aliyun.handle_request')
@patch('mash.services.api.v1.routes.accounts.aliyun.get_jwt_identity')
...
def test_api_delete_account_aliyun(
    ...
    result = test_client.delete('/v1/accounts/aliyun/test')
...
def test_api_get_account_aliyun(
    ...
    result = test_client.get('/v1/accounts/aliyun/test')
...
def test_api_get_account_list_aliyun(
    ...
    result = test_client.get('/v1/accounts/aliyun/')
