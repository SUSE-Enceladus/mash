...
@patch('mash.services.api.utils.tokens.handle_request')
...
def test_api_token_list(
    ...
    result = test_client.get('/auth/token')
...
def test_api_delete_tokens(
    ...
    result = test_client.delete('/auth/token')
...
def test_api_delete_token(
    ...
    result = test_client.delete('/auth/token/54321')
...
def test_api_get_token(
    ...
    result = test_client.get('/auth/token/54321')
